...
3. 采集 NQ 激活与标签：
   ...
   - 运行示例（使用 chat 模板）：
     - `python RAG/llama_get_activations.py --model_name vicuna_7B_v1.5 --dataset_name nq --use_chat_template --nq_jsonl RAG/data/NQ/llama_2_chat_7b_train_user.jsonl --output_dir RAG/features/vicuna_7B_v1.5_nq_user`
   - 产物：`RAG/features/{model}_nq_head_wise.npy`、`RAG/features/{model}_nq_labels.npy`、可选 `tokens.pkl`。

## 训练探针

- 基本命令：
  - `python RAG/train_save_probes.py --model_name vicuna_7B_v1.5 --num_heads 32 --head_dim 128 --feat_dir RAG/features/vicuna_7B_v1.5_nq_user --save_dir RAG/probes/vicuna_7B_v1.5_nq_user --cv_final_train full`
...
## 获取探针的验证集分数
- 基本命令：
  - `python RAG/utils/inspect_probes.py RAG/probes/vicuna_7B_v1.5_nq_user/vicuna_7B_v1.5_nq_seed_2025_top_1024_folds_3_val_accs.npy --out-csv RAG/probes/vicuna_7B_v1.5_nq_user/accs_csv.csv`

## 热力图工具
- 基本命令
  - `python RAG/utils/plot_probe_heatmap.py /root/shared-nvme/RAG-llm/RAG/probes/vicuna_7B_v1.5_nq_user/accs_csv.csv --output /root/shared-nvme/RAG-llm/RAG/probes/vicuna_7B_v1.5_nq_user/accs_heatmap.png --cmap turbo --bins 12 --discrete`
...
--alphas 5 --probe_factor_modes false --max_new_tokens 256 --include_strategies topk_448_by_score --results_root RAG/results/vicuna-7b-v1.5-nq-user/topk_448_by_score_alphas_5 --sample_size 300 --timeout_minutes 6
```
...
--tuning_labels_path RAG/features/vicuna_7B_v1.5_nq_user/vicuna_7B_v1.5_nq_labels.npy \
--scores_csv RAG/probes/vicuna_7B_v1.5_nq_user/accs_csv.csv \
--alphas 5 --probe_factor_modes false --max_new_tokens 256 --include_strategies topk_448_by_score --results_root RAG/results/vicuna-7b-v1.5-triviaqa-user/topk_448_by_score_alphas_5 --sample_size 300
```
...
--tuning_labels_path RAG/features/vicuna_7B_v1.5_nq_user/vicuna_7B_v1.5_nq_labels.npy \
--scores_csv RAG/probes/vicuna_7B_v1.5_nq_user/accs_csv.csv \
--alphas 5 --probe_factor_modes false --max_new_tokens 256 --include_strategies topk_448_by_score --results_root RAG/results/vicuna-7b-v1.5-popqa-user/topk_448_by_score_alphas_5 --sample_size 300
```
...
--tuning_labels_path RAG/features/vicuna_7B_v1.5_nq_user/vicuna_7B_v1.5_nq_labels.npy \
--scores_csv RAG/probes/vicuna_7B_v1.5_nq_user/accs_csv.csv \
--results_root RAG/results/vicuna-7b-v1.5-alpha-search \
--sample_size 100 \
--max_new_tokens 256
```
